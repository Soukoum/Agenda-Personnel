<%-- 
    Document   : listeEvenementJour
    Created on : 19 janv. 2022, 14:19:56
    Author     : ADMIN
--%>
                            ...
                            <div class="card text-center">
                                <div class="card-header">
                                  <ul class="nav nav-tabs card-header-tabs">
                                    ...
                                    <li class="nav-item">
                                      <a class="nav-link active" style="background-color: #1DDCB6;">Jour</a>
                                    </li>
                                  </ul>
                                </div>
                            </div>
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        ...
                        <% 
                            ...
                            while(rs.next()){
                            if (rs.getString(2).equals(d) || rs.getString(3).equals(d)){
                        %>
                    </thead>
                    <tbody class="result"> 
                        <tr>
