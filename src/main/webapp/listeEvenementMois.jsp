<%-- 
    Document   : listeEvenementMois
    Created on : 8 févr. 2022, 21:11:34
    Author     : ADMIN
--%>
                            ...
                            <div class="card text-center">
                                <div class="card-header">
                                  <ul class="nav nav-tabs card-header-tabs">
                                    ...
                                    <li class="nav-item">
                                      <a class="nav-link active" style="background-color: #1DDCB6;">Mois</a>
                                    </li>
                                    <li class="nav-item">
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        ...
                        <% 
                            ...
                            c2.setTime(d2);
                            if(c1.get(c1.MONTH) == c.get(c.MONTH)){
                         %>
                    </thead>
                    <tbody class="result"> 
                        <tr>
